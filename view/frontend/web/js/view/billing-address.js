...
define(
    ...
    function (
        ...
        return Component.extend({
            ...
            {
                if(!customer.isLoggedIn() && this.isAddressSameAsShipping() && jQuery('#shipping-new-address-form input[name="observaciones"]').val())
                {
                    return ', Observaciones: '+ jQuery('#shipping-new-address-form input[name="observaciones"]').val();
                }

                if(typeof this.currentBillingAddress() != "undefined" && typeof this.currentBillingAddress().customAttributes != "undefined")
                {
                    if(typeof this.currentBillingAddress().customAttributes.observaciones != "undefined" &&
                        typeof this.currentBillingAddress().customAttributes.observaciones.value != "undefined")
                        return ', Observaciones: '+ this.currentBillingAddress().customAttributes.observaciones.value;
                    if(typeof this.currentBillingAddress().customAttributes.observaciones != "undefined")
                        return ', Observaciones: '+ this.currentBillingAddress().customAttributes.observaciones;
