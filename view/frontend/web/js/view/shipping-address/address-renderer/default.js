...
define([
    ...
    return Component.extend({
        ...
        getObservaciones: function () {
            if(typeof(this.address()) != "undefined" && typeof(this.address().customAttributes) != "undefined" && typeof(this.address().customAttributes.observaciones) != "undefined")
                return ', Observaciones: '+ this.address().customAttributes.observaciones.value;
            else
                return '';
        }
    });
